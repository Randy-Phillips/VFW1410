...
@interface phillips_randy_project1Object : KrollCoverageObject {
#else
@interface phillips_randy_project1Object : KrollObject {
#endif
@private
...
extern NSString * phillips_randy_project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	phillips_randy_project1Object *_phillips_randy_project1;
    KrollObject* console;
	BOOL shutdown;
