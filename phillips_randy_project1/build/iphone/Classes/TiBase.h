...
// in simulator we redefine to format for phillips_randy_project1 Developer console
...
{\
	NSString * exceptionName = [@"org.phillips_randy_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phillips_randy_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIphillips_randy_project1NativeItemNone = -1, 
	UIphillips_randy_project1NativeItemSpinner = -2,
	UIphillips_randy_project1NativeItemProgressBar = -3,
	
	UIphillips_randy_project1NativeItemSlider = -4,
	UIphillips_randy_project1NativeItemSwitch = -5,
	UIphillips_randy_project1NativeItemMultiButton = -6,
	UIphillips_randy_project1NativeItemSegmented = -7,
	
	UIphillips_randy_project1NativeItemTextView = -8,
	UIphillips_randy_project1NativeItemTextField = -9,
	UIphillips_randy_project1NativeItemSearchBar = -10,
	
	UIphillips_randy_project1NativeItemPicker = -11,
	UIphillips_randy_project1NativeItemDatePicker = -12,
	
	UIphillips_randy_project1NativeItemInfoLight = -13,
	UIphillips_randy_project1NativeItemInfoDark = -14,
	
	UIphillips_randy_project1NativeItemDisclosure = -15,
	
	UIphillips_randy_project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all phillips_randy_project1 instances of
