 ...
 * to send analytic data that can be viewed on the phillips_randy_project1 Dashboard.
 *
 * For information on getting started with phillips_randy_project1 Platform Services,
