...
//@interface phillips_randy_project1Object : NSObject
//@end

@interface phillips_randy_project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[phillips_randy_project1Object class]])
		{
			for (NSString *key in [[(phillips_randy_project1Object*)o modules] allKeys])
			{
