...
/**
 Base class for all phillips_randy_project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the phillips_randy_project1 view hierarchy (such as wrapped iOS UIViews) was touched.
