...
//@interface phillips_randy_project33Object : NSObject
//@end

@interface phillips_randy_project33Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[phillips_randy_project33Object class]])
		{
			for (NSString *key in [[(phillips_randy_project33Object*)o modules] allKeys])
			{
