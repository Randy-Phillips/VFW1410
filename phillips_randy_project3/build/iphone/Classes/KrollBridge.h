...
@interface phillips_randy_project33Object : KrollCoverageObject {
#else
@interface phillips_randy_project33Object : KrollObject {
#endif
@private
...
extern NSString * phillips_randy_project33$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	phillips_randy_project33Object *_phillips_randy_project33;
    KrollObject* console;
	BOOL shutdown;
