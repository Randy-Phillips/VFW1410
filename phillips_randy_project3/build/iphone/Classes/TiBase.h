...
// in simulator we redefine to format for phillips_randy_project33 Developer console
...
{\
	NSString * exceptionName = [@"org.phillips_randy_project33." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phillips_randy_project33";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIphillips_randy_project33NativeItemNone = -1, 
	UIphillips_randy_project33NativeItemSpinner = -2,
	UIphillips_randy_project33NativeItemProgressBar = -3,
	
	UIphillips_randy_project33NativeItemSlider = -4,
	UIphillips_randy_project33NativeItemSwitch = -5,
	UIphillips_randy_project33NativeItemMultiButton = -6,
	UIphillips_randy_project33NativeItemSegmented = -7,
	
	UIphillips_randy_project33NativeItemTextView = -8,
	UIphillips_randy_project33NativeItemTextField = -9,
	UIphillips_randy_project33NativeItemSearchBar = -10,
	
	UIphillips_randy_project33NativeItemPicker = -11,
	UIphillips_randy_project33NativeItemDatePicker = -12,
	
	UIphillips_randy_project33NativeItemInfoLight = -13,
	UIphillips_randy_project33NativeItemInfoDark = -14,
	
	UIphillips_randy_project33NativeItemDisclosure = -15,
	
	UIphillips_randy_project33NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all phillips_randy_project33 instances of
