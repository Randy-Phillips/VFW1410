...
//Rare exceptions to indicate a bug in the _phillips_randy_project33 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for phillips_randy_project33 proxies.
 */
