...
/**
 The base class for all phillips_randy_project33 modules
 */
...
/**
 phillips_randy_project33 Platform calls this method on startup.
 */
-(void)startup;

/**
 phillips_randy_project33 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 phillips_randy_project33 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 phillips_randy_project33 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 phillips_randy_project33 Platform calls this method on resume.
 @param sender The sender of the event.
 */
