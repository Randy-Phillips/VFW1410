 ...
 * to send analytic data that can be viewed on the rPhillips_Project11 Dashboard.
 *
 * For information on getting started with rPhillips_Project11 Platform Services,
