...
//@interface rPhillips_Project11Object : NSObject
//@end

@interface rPhillips_Project11Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[rPhillips_Project11Object class]])
		{
			for (NSString *key in [[(rPhillips_Project11Object*)o modules] allKeys])
			{
