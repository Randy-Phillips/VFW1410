...
// in simulator we redefine to format for rPhillips_Project11 Developer console
...
{\
	NSString * exceptionName = [@"org.rphillips_project11." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rphillips_project11";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrPhillips_Project11NativeItemNone = -1, 
	UIrPhillips_Project11NativeItemSpinner = -2,
	UIrPhillips_Project11NativeItemProgressBar = -3,
	
	UIrPhillips_Project11NativeItemSlider = -4,
	UIrPhillips_Project11NativeItemSwitch = -5,
	UIrPhillips_Project11NativeItemMultiButton = -6,
	UIrPhillips_Project11NativeItemSegmented = -7,
	
	UIrPhillips_Project11NativeItemTextView = -8,
	UIrPhillips_Project11NativeItemTextField = -9,
	UIrPhillips_Project11NativeItemSearchBar = -10,
	
	UIrPhillips_Project11NativeItemPicker = -11,
	UIrPhillips_Project11NativeItemDatePicker = -12,
	
	UIrPhillips_Project11NativeItemInfoLight = -13,
	UIrPhillips_Project11NativeItemInfoDark = -14,
	
	UIrPhillips_Project11NativeItemDisclosure = -15,
	
	UIrPhillips_Project11NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all rPhillips_Project11 instances of
