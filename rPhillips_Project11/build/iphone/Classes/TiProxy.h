...
//Rare exceptions to indicate a bug in the _rphillips_project11 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for rPhillips_Project11 proxies.
 */
