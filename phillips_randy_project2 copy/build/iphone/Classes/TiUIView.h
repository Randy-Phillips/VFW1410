...
/**
 Base class for all phillips_randy_project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the phillips_randy_project2 view hierarchy (such as wrapped iOS UIViews) was touched.
