...
/**
 Base class for all rPhillips_Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the rPhillips_Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
