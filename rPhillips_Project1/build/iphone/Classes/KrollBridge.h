...
@interface rPhillips_Project1Object : KrollCoverageObject {
#else
@interface rPhillips_Project1Object : KrollObject {
#endif
@private
...
extern NSString * rPhillips_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	rPhillips_Project1Object *_rphillips_project1;
    KrollObject* console;
	BOOL shutdown;
