...
/**
 The base class for all rPhillips_Project1 modules
 */
...
/**
 rPhillips_Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 rPhillips_Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 rPhillips_Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 rPhillips_Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 rPhillips_Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
