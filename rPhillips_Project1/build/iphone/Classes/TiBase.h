...
// in simulator we redefine to format for rPhillips_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.rphillips_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.rphillips_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrPhillips_Project1NativeItemNone = -1, 
	UIrPhillips_Project1NativeItemSpinner = -2,
	UIrPhillips_Project1NativeItemProgressBar = -3,
	
	UIrPhillips_Project1NativeItemSlider = -4,
	UIrPhillips_Project1NativeItemSwitch = -5,
	UIrPhillips_Project1NativeItemMultiButton = -6,
	UIrPhillips_Project1NativeItemSegmented = -7,
	
	UIrPhillips_Project1NativeItemTextView = -8,
	UIrPhillips_Project1NativeItemTextField = -9,
	UIrPhillips_Project1NativeItemSearchBar = -10,
	
	UIrPhillips_Project1NativeItemPicker = -11,
	UIrPhillips_Project1NativeItemDatePicker = -12,
	
	UIrPhillips_Project1NativeItemInfoLight = -13,
	UIrPhillips_Project1NativeItemInfoDark = -14,
	
	UIrPhillips_Project1NativeItemDisclosure = -15,
	
	UIrPhillips_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all rPhillips_Project1 instances of
