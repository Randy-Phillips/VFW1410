 ...
 * to send analytic data that can be viewed on the rPhillips_Project1 Dashboard.
 *
 * For information on getting started with rPhillips_Project1 Platform Services,
