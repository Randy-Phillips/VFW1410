...
//Rare exceptions to indicate a bug in the _rphillips_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for rPhillips_Project1 proxies.
 */
