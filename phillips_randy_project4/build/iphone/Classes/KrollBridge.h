...
@interface phillips_randy_project4Object : KrollCoverageObject {
#else
@interface phillips_randy_project4Object : KrollObject {
#endif
@private
...
extern NSString * phillips_randy_project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	phillips_randy_project4Object *_phillips_randy_project4;
    KrollObject* console;
	BOOL shutdown;
