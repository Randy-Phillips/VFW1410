 ...
 * to send analytic data that can be viewed on the phillips_randy_project4 Dashboard.
 *
 * For information on getting started with phillips_randy_project4 Platform Services,
