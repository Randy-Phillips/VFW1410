...
//@interface phillips_randy_project4Object : NSObject
//@end

@interface phillips_randy_project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[phillips_randy_project4Object class]])
		{
			for (NSString *key in [[(phillips_randy_project4Object*)o modules] allKeys])
			{
