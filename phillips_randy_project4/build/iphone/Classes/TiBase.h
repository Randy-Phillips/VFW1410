...
// in simulator we redefine to format for phillips_randy_project4 Developer console
...
{\
	NSString * exceptionName = [@"org.phillips_randy_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phillips_randy_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIphillips_randy_project4NativeItemNone = -1, 
	UIphillips_randy_project4NativeItemSpinner = -2,
	UIphillips_randy_project4NativeItemProgressBar = -3,
	
	UIphillips_randy_project4NativeItemSlider = -4,
	UIphillips_randy_project4NativeItemSwitch = -5,
	UIphillips_randy_project4NativeItemMultiButton = -6,
	UIphillips_randy_project4NativeItemSegmented = -7,
	
	UIphillips_randy_project4NativeItemTextView = -8,
	UIphillips_randy_project4NativeItemTextField = -9,
	UIphillips_randy_project4NativeItemSearchBar = -10,
	
	UIphillips_randy_project4NativeItemPicker = -11,
	UIphillips_randy_project4NativeItemDatePicker = -12,
	
	UIphillips_randy_project4NativeItemInfoLight = -13,
	UIphillips_randy_project4NativeItemInfoDark = -14,
	
	UIphillips_randy_project4NativeItemDisclosure = -15,
	
	UIphillips_randy_project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all phillips_randy_project4 instances of
