...
//@interface phillips_randy_project2Object : NSObject
//@end

@interface phillips_randy_project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[phillips_randy_project2Object class]])
		{
			for (NSString *key in [[(phillips_randy_project2Object*)o modules] allKeys])
			{
