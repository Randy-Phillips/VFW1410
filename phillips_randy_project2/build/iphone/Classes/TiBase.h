...
// in simulator we redefine to format for phillips_randy_project2 Developer console
...
{\
	NSString * exceptionName = [@"org.phillips_randy_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phillips_randy_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIphillips_randy_project2NativeItemNone = -1, 
	UIphillips_randy_project2NativeItemSpinner = -2,
	UIphillips_randy_project2NativeItemProgressBar = -3,
	
	UIphillips_randy_project2NativeItemSlider = -4,
	UIphillips_randy_project2NativeItemSwitch = -5,
	UIphillips_randy_project2NativeItemMultiButton = -6,
	UIphillips_randy_project2NativeItemSegmented = -7,
	
	UIphillips_randy_project2NativeItemTextView = -8,
	UIphillips_randy_project2NativeItemTextField = -9,
	UIphillips_randy_project2NativeItemSearchBar = -10,
	
	UIphillips_randy_project2NativeItemPicker = -11,
	UIphillips_randy_project2NativeItemDatePicker = -12,
	
	UIphillips_randy_project2NativeItemInfoLight = -13,
	UIphillips_randy_project2NativeItemInfoDark = -14,
	
	UIphillips_randy_project2NativeItemDisclosure = -15,
	
	UIphillips_randy_project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all phillips_randy_project2 instances of
