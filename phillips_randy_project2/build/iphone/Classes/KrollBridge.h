...
@interface phillips_randy_project2Object : KrollCoverageObject {
#else
@interface phillips_randy_project2Object : KrollObject {
#endif
@private
...
extern NSString * phillips_randy_project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	phillips_randy_project2Object *_phillips_randy_project2;
    KrollObject* console;
	BOOL shutdown;
